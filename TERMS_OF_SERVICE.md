# Terms of Service for Cents and Sense

**Last Updated: March 6, 2026**

## Agreement to Terms

By accessing and using Cents and Sense ("the app", "we", "our"), you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the app.
...
**Important**: Regularly export your data to prevent loss.

## Disclaimer of Warranties

THE APP IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:

- **Accuracy**: We do not guarantee the accuracy of calculations or financial projections
- **Availability**: The app may be unavailable due to maintenance or updates
- **Compatibility**: The app may not work on all devices or OS versions
- **Financial Advice**: The app does not provide professional financial advice

## Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW:

- We are not liable for any financial decisions you make based on app data
- We are not responsible for any loss of data or financial information
- We are not liable for any damages arising from app use or inability to use the app
- Our total liability shall not exceed the amount you paid for the app (which is $0 for the free version)

## Financial Disclaimer

**Cents and Sense is a financial tracking tool, not a financial advisor.**

- The app does not provide financial, investment, tax, or legal advice
- All financial decisions are your sole responsibility
- Consult with licensed professionals for financial planning advice
- Past performance tracking does not guarantee future results
- Budget calculations and projections are estimates only
...
- Attempt to reverse engineer or modify the app in harmful ways
- Distribute malware or harmful code
- Impersonate others or provide false information to support
...
4. Resort to legal proceedings only as a last resort
...
These Terms constitute the entire agreement between you and Cents and Sense regarding use of the app.

## Contact Information

For questions about these Terms:

- **GitHub Issues**: https://github.com/waqarilyas/budget-tracker-app-development/issues
- **GitHub Discussions**: https://github.com/waqarilyas/budget-tracker-app-development/discussions
...
BY USING CENTS AND SENSE, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY THEM.
